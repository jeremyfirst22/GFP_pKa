...
fileList = glob.glob('A_State/*/6_NEARBY_WAT_ENERGIES/dG_xter_CRO.dat') 
mutList = [] 
...
for index,mut in enumerate(mutList): 
    ...
    #print bashCommand
    dataFileA="../A_State/%s/6_NEARBY_WAT_ENERGIES/dG_xter_CRO.dat"%mut
    dataFileB="../B_State/%s/6_NEARBY_WAT_ENERGIES/dG_xter_CRB.dat"%mut
...
fig2.savefig('6_Nearby_Wat_pKa_cryst.pdf', format='pdf') 
...
fig3.savefig('6_Nearby_Wat_residuals.pdf',format='pdf') 
