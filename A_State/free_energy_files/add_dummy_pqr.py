...
record1=['ATOM','0','DUM', 'CNF','0',str(np.round(dum1[0],decimals=3)),str(np.round(dum1[1],decimals=3)),str(np.round(dum1[2],decimals=3)), '0.00', '0.00'] 
record2=['ATOM','0','DUM', 'CNF','0',str(np.round(dum2[0],decimals=3)),str(np.round(dum2[1],decimals=3)),str(np.round(dum2[2],decimals=3)), '0.00', '0.00'] 
