...
if [ ! -d NEARBY_10_LOWE ] ; then mkdir NEARBY_10_LOWE ; fi 
cd NEARBY_10_LOWE
...
printf "\n\t*** pdb2pqr and APBS    ***\n\n" 
index=0
echo "group Protein || (group Water and same residue as within 1.0 of (resname CROn and name OH)) " > selection.dat
