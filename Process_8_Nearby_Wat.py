...
fileList = glob.glob('A_State/*/8_NEARBY_WAT_ENERGIES/dG_xter_CRO.dat') 
mutList = [] 
...
for index,mut in enumerate(mutList): 
    ...
    #print bashCommand
    dataFileA="../A_State/%s/8_NEARBY_WAT_ENERGIES/dG_xter_CRO.dat"%mut
    dataFileB="../B_State/%s/8_NEARBY_WAT_ENERGIES/dG_xter_CRB.dat"%mut
...
ax1.legend() 
fig1.savefig('8_Nearby_Wat_pKa.pdf', format='pdf') 
...
fig2.savefig('8_Nearby_Wat_pKa_cryst.pdf', format='pdf') 
...
fig3.savefig('8_Nearby_Wat_residuals.pdf',format='pdf') 
