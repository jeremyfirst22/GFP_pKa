...
fileList = glob.glob('A_State/*/NEARBY_10_ENERGIES/dG_xter_CRO.dat') 
mutList = [] 
...
for index,mut in enumerate(mutList): 
    mut=mutList[index]
    outName = "Nearby_10_%s_ddG.pdf"%mut
    ...
    #print bashCommand
    dataFileA="../A_State/%s/NEARBY_10_ENERGIES/dG_xter_CRO.dat"%mut
    dataFileB="../B_State/%s/NEARBY_10_ENERGIES/dG_xter_CRB.dat"%mut
...
ax1.legend() 
fig1.savefig('Nearby_10_pKa.pdf', format='pdf') 
...
fig2.savefig('Nearby_10_pKa_cryst.pdf', format='pdf') 
