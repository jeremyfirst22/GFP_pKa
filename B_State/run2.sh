...
#"
molecList="CN145_T203N     CN165_T203N     GFP_WT_T203N" 
...
for molec in $molecList ; do 
    ...
    time bash run_GFP.sh StartingStructures/$molec.pdb

    #time bash force_calc_APBS.sh $molec
    #time bash force_calc_with_nearby_APBS.sh $molec

    time bash dG_transfer_calc_CRB.sh $molec
    time bash dG_transfer_calc_20_CRB.sh $molec
    time bash dG_transfer_calc_6_CRB.sh $molec

    time bash dG_transfer_calc_6_with_nearby_wat.sh $molec
    time bash dG_transfer_calc_8_with_nearby_wat.sh $molec
